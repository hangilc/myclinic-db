...
var initDb = util.createClearTableFun(["hoken_roujin"]);

function mkHoken(patientId, validFrom, validUpto){
	return m.roujin({patient_id: patientId, valid_from: validFrom, valid_upto: validUpto});
}

describe("Testing available roujin", function(){
	var conn;
